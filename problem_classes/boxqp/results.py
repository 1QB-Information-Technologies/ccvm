...
class Results:
    """Define the results class of a solve."""

    def __init__(self):
        """The constructor for Results.
        :ivar results: a list of Result
        :type results: list, default to empty
        """
    ...
    def add_result(
        ...
        """Create a result object with given inputs and append it to the results list.
...
class Result:
    ...
    :param device: Device to use, one of: "cpu" or "cuda"
    :type device: string
    :ivar result_performance: a dictionary contains the following fields
    ...
    :type result_performance: dict, default to None
    """
    ...
    result_performance: dict = None

    def __post_init__(self):
        self.get_result_stats()

    def get_result_stats(self):

        """A method that calculates the measurement of solutions that were optimal, within 1%, 2%, 3%, 4%, 5% and 10% of optimal and update the result."""
