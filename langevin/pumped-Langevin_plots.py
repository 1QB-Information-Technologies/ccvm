...
file_path = f"./results/results_Langevin-CIM_{post_method}_{device}_{instance_type}.txt"
result_path = f"./results/tts_Langevin-CIM_{post_method}_{device}_{instance_type}.txt"
...
df["category"] = df["pump_rate"] + df["scaling"] + df["noise"] + df["lr"] + df["n_iter"]
...
# instance_sizes = ["20", "30", "40", "50", "60", "70", "80", "90", "100", "125"]
...
if TTS_method == "best":
    ...
    basic_hypers = {
        "20": "1.5None0.020.0115000",
        "30": "1.5None0.020.0115000",
        "40": "2.0None0.020.00515000",
        "50": "2.0None0.020.0115000",
        "60": "1.8None0.020.00515000",
        "70": "1.8None0.020.0115000",
        "80": "",
        "90": "",
        "100": "",
        "110": "",
...
# x_vals = ["20", "30", "40", "50", "60", "70", "80", "90", "100", "110", "120"]
x_vals = ["20", "30", "40", "50", "60", "70"]
...
if plot_TTS:
    ...
    # plt.legend(
    #     loc="upper left", fontsize=fonts["legend"]
    ...
    plt.savefig(
        f"./results/tts_boxed_qp_Langevin-CIM_{post_method}_{TTS_type}_{device}_{instance_type}.pdf",
        bbox_inches="tight",
    )
...
if plot_success_p:
    ...
    plt.tight_layout()
    plt.savefig(
        f"./results/sp_boxed_qp_Langevin-CIM_{post_method}_{device}.png",
        bbox_inches="tight",
    )
    plt.show()
