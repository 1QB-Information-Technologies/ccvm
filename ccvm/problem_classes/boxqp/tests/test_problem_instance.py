...
class TestProblemInstance(TestCase):
    ...
    def test_load_instance_cpu_and_basic_type(self):
        ...
        problem_instance = ProblemInstance.__new__(ProblemInstance)
        
        problem_instance.__init__(
            device=self.device,
            instance_type=self.instance_type,
            file_path=self.file_path,
        )
    ...
    #     filepath = self.basepath + "/test_instances/test020-100-10.in"
    ...
    #     assert torch.eq(expected_result, energy)
